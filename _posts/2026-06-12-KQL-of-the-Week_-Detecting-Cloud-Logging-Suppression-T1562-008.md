---
layout: post
title: "KQL Detection of the Week: Detecting Cloud Logging Suppression (T1562.008)"
subtitle: "Catching the attacker who turns off the cameras before the exploitation even starts"
date: 2026-06-12
author: DevSecOpsDad
tags:
...
It was looking for the moment an attacker makes sure you'll never *see* the exploitation. That's a very different problem — and it's why this week's KQL Detection of the Week is the Azure logging-suppression sequence from Wednesday and Thursday's briefs.
