---
layout: post
title: "KQL Detection of the Week: A Name Is a Claim, Not a Fact"
subtitle: "Three detections that refused to trust a process name, a storage-bucket name, or a route's protection promise at face value"
date: 2026-06-29
author: DevSecOpsDad
tags:
...
So this week's KQL Detection of the Week is a theme, told in three queries from three different briefs: **a name is a claim, not a fact.** Act I is on Linux. Act II is in Azure. The honorable mention is on the modern web. Different telemetry, different platform, same move every time — *don't match the name against a blocklist, match the name against the fact it's supposed to imply.*
