---
layout: page
title: 30 60 90 Day Common Security Log Ingest Trends
subtitle: "Compare `CommonSecurityLog` volume by `DeviceAction` across 30-, 60-, and 90-day periods to spot which actions are driving growth."
permalink: /kql-library/cost-and-ingest/30-60-90-day-common-security-log-ingest-trends/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">30-60-90-day-common-security-log-ingest-trends.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/cost-and-ingest/ingest-trends/30-60-90-day-common-security-log-ingest-trends.kql' | relative_url }}" download="30-60-90-day-common-security-log-ingest-trends.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-30-60-90-day-common-security-log-ingest-trends" markdown="1">
