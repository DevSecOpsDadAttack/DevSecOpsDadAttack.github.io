---
layout: page
title: 30 60 90 Day Ingest Trends
subtitle: "Same three-window comparison against the `Usage` table for a workspace-wide view."
permalink: /kql-library/cost-and-ingest/30-60-90-day-ingest-trends/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">30-60-90-day-ingest-trends.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/cost-and-ingest/ingest-trends/30-60-90-day-ingest-trends.kql' | relative_url }}" download="30-60-90-day-ingest-trends.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-30-60-90-day-ingest-trends" markdown="1">
