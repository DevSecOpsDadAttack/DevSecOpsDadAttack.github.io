...
subtitle: "Grab-bag of reporting queries starting with MTTR against `SecurityIncident`."
permalink: /kql-library/reporting/report-queries/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">report-queries.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/reporting/report-queries.kql' | relative_url }}" download="report-queries.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-report-queries" markdown="1">
