---
layout: page
title: Detect Sharepoint Toolshell Rce Encoded Command
subtitle: "SharePoint ToolShell RCE: encoded PowerShell arriving via SharePoint worker processes. Multi-token needles (`certutil -decode`) need `contains`, not `has_any`."
permalink: /kql-library/analytics-rules/detect-sharepoint-toolshell-rce-encoded-command/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">detect-sharepoint-toolshell-rce-encoded-command.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  <a class="kql-lib-deep-dive-btn" href="https://devsecopsdadattack.com/2026-08-18-KQL-Detection-of-the-Week-The-Query-That-Wrote-Itself-Eight-Times/" target="_blank" rel="noopener">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/analytics-rules/detect-sharepoint-toolshell-rce-encoded-command.kql' | relative_url }}" download="detect-sharepoint-toolshell-rce-encoded-command.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-detect-sharepoint-toolshell-rce-encoded-command" markdown="1">
