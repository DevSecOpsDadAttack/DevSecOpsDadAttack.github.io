---
layout: page
title: Detect Telegram Tdata Session Theft File Access
subtitle: "Theft of Telegram's tdata session directory by an unexpected process. Uses actual DeviceFileEvents ActionTypes (FileCreated/Modified) — `FileRead` doesn't exist."
permalink: /kql-library/analytics-rules/detect-telegram-tdata-session-theft-file-access/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">detect-telegram-tdata-session-theft-file-access.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/analytics-rules/detect-telegram-tdata-session-theft-file-access.kql' | relative_url }}" download="detect-telegram-tdata-session-theft-file-access.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-detect-telegram-tdata-session-theft-file-access" markdown="1">
