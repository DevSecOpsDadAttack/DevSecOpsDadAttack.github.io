---
layout: page
title: Inventory Installed Npm Packages With Lifecycle Scripts
subtitle: "Inventory of npm packages installed across your fleet that carry postinstall / preinstall / install lifecycle scripts — the finite, closable population for sins-of-the-grandfather class attacks."
permalink: /kql-library/posture/inventory-installed-npm-packages-with-lifecycle-scripts/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">inventory-installed-npm-packages-with-lifecycle-scripts.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  <a class="kql-lib-deep-dive-btn" href="https://devsecopsdadattack.com/2026-08-12-KQL-Detection-of-the-Week-Sins-of-the-Grandfather/" target="_blank" rel="noopener">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/posture/inventory-installed-npm-packages-with-lifecycle-scripts.kql' | relative_url }}" download="inventory-installed-npm-packages-with-lifecycle-scripts.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-inventory-installed-npm-packages-with-lifecycle-scripts" markdown="1">
