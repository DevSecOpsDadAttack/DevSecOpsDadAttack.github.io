---
layout: page
title: Which Devices Are Internet Facing
subtitle: "Identify internet-facing devices — walks through what 'public' actually means for both IPv4 and IPv6 before matching."
permalink: /kql-library/posture/which-devices-are-internet-facing/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">which-devices-are-internet-facing.kql</code>
</div>

<p class="kql-lib-query-longdesc">Identify internet-facing devices — walks through what "public" actually means for both IPv4 and IPv6 before matching.</p>
...
<div class="kql-lib-tags-block">
  ...
  <div class="kql-lib-tag-row">
    ...
    <a class="kql-lib-tag kql-lib-tag-technique" href="{{ '/kql-library/tag/t1590-005/' | relative_url }}">T1590.005</a>
  </div>
  <div class="kql-lib-tag-row">
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/posture/which-devices-are-internet-facing.kql' | relative_url }}" download="which-devices-are-internet-facing.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-which-devices-are-internet-facing" markdown="1">
