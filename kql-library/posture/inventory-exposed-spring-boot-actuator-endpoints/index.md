---
layout: page
title: Inventory Exposed Spring Boot Actuator Endpoints
subtitle: "Inventory of Spring Boot Actuator endpoints that answer 200 anywhere in your estate — flips the entity from 'who scanned us' (infinite) to 'which of my services answer' (finite and fixable). Recovers the real management base path from tr..."
permalink: /kql-library/posture/inventory-exposed-spring-boot-actuator-endpoints/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">inventory-exposed-spring-boot-actuator-endpoints.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/posture/inventory-exposed-spring-boot-actuator-endpoints.kql' | relative_url }}" download="inventory-exposed-spring-boot-actuator-endpoints.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-inventory-exposed-spring-boot-actuator-endpoints" markdown="1">
