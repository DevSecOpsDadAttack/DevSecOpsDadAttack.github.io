---
layout: page
title: Hunt Spring Boot Heapdump Exfiltration Asim
subtitle: "Hunts Spring Boot Actuator heap-dump exfiltration in ASIM Web Session data by matching the endpoint ID as a path segment (position-independent) instead of hardcoding `/actuator/heapdump`. Recovers the real base path from traffic and rank..."
permalink: /kql-library/hunting/hunt-spring-boot-heapdump-exfiltration-asim/
js:
...
<div class="kql-lib-query-header">
  ...
  <span class="attack-badge attack-badge-sub">Web Tier</span>
  <code class="kql-lib-query-file">hunt-spring-boot-heapdump-exfiltration-asim.kql</code>
</div>

<p class="kql-lib-query-longdesc">Hunts Spring Boot Actuator heap-dump exfiltration in ASIM Web Session data by matching the endpoint ID as a path segment (position-independent) instead of hardcoding `/actuator/heapdump`. Recovers the real base path from traffic and ranks by response-size verdict.</p>
...
<div class="kql-lib-query-actions">
  <a class="kql-lib-deep-dive-btn" href="https://devsecopsdadattack.com/2026-08-03-KQL-Detection-of-the-Week_-A-Heap-of-Trouble-Detecting-Spring-Boot-Heapdump-Theft-When-the-Exfiltration-Is-a-GET-Request_/" target="_blank" rel="noopener">
    <i class="fas fa-bolt" aria-hidden="true"></i>&nbsp;Deep Dive
  </a>
  <button type="button" class="kql-lib-copy-btn" data-copy-target="kql-code-hunt-spring-boot-heapdump-exfiltration-asim">
    <i class="far fa-copy" aria-hidden="true"></i>&nbsp;Copy query
  </button>
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/hunting/web-tier/hunt-spring-boot-heapdump-exfiltration-asim.kql' | relative_url }}" download="hunt-spring-boot-heapdump-exfiltration-asim.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-hunt-spring-boot-heapdump-exfiltration-asim" markdown="1">
