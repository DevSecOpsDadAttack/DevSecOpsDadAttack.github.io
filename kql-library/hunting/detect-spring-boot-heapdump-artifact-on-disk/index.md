---
layout: page
title: Detect Spring Boot Heapdump Artifact On Disk
subtitle: "Detects Spring Boot Actuator heap-dump theft by the artifact Spring writes to disk during the request (`heapdump<timestamp>[-live]<digits>.hprof`). The filename is proof an HTTP request hit the endpoint even when the web tier didn't log ..."
permalink: /kql-library/hunting/detect-spring-boot-heapdump-artifact-on-disk/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">detect-spring-boot-heapdump-artifact-on-disk.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/hunting/file-activity/detect-spring-boot-heapdump-artifact-on-disk.kql' | relative_url }}" download="detect-spring-boot-heapdump-artifact-on-disk.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-detect-spring-boot-heapdump-artifact-on-disk" markdown="1">
