---
layout: page
title: Hunt Spring Boot Heapdump Exfiltration Commonsecuritylog
subtitle: "Non-ASIM (`CommonSecurityLog`) variant of the heap-dump hunt. Uses correct CEF field names (`ReceivedBytes` / `SentBytes`) and carries both byte directions because CEF doesn't tell you which side is the response."
permalink: /kql-library/hunting/hunt-spring-boot-heapdump-exfiltration-commonsecuritylog/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">hunt-spring-boot-heapdump-exfiltration-commonsecuritylog.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/hunting/web-tier/hunt-spring-boot-heapdump-exfiltration-commonsecuritylog.kql' | relative_url }}" download="hunt-spring-boot-heapdump-exfiltration-commonsecuritylog.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-hunt-spring-boot-heapdump-exfiltration-commonsecuritylog" markdown="1">
