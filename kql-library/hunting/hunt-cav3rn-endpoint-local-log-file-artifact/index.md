---
layout: page
title: Hunt Cav3rn Endpoint Local Log File Artifact
subtitle: "Endpoint-side hunt for Project CAV3RN's local file artifact (`logAzure.txt` and family) — config persistence written by the module."
permalink: /kql-library/hunting/hunt-cav3rn-endpoint-local-log-file-artifact/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">hunt-cav3rn-endpoint-local-log-file-artifact.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/hunting/hunt-cav3rn-endpoint-local-log-file-artifact.kql' | relative_url }}" download="hunt-cav3rn-endpoint-local-log-file-artifact.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-hunt-cav3rn-endpoint-local-log-file-artifact" markdown="1">
