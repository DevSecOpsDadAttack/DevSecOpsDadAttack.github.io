---
layout: page
title: Hunt Metadata IP Any Encoded Form Inspecting DNS Answer
subtitle: "Inspects what DNS actually resolved to (the Answer field), not what the caller wrote — catches every obfuscated string form of the metadata IPs at the resolver level."
permalink: /kql-library/hunting/hunt-metadata-ip-any-encoded-form-inspecting-dns-answer/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">hunt-metadata-ip-any-encoded-form-inspecting-dns-answer.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/hunting/hunt-metadata-ip-any-encoded-form-inspecting-dns-answer.kql' | relative_url }}" download="hunt-metadata-ip-any-encoded-form-inspecting-dns-answer.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-hunt-metadata-ip-any-encoded-form-inspecting-dns-answer" markdown="1">
