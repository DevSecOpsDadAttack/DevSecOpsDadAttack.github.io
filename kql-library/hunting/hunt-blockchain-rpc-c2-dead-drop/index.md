---
layout: page
title: Hunt Blockchain Rpc C2 Dead Drop
subtitle: "C2 traffic hidden inside blockchain-RPC calls to public utilities (QuickNode, Alchemy) — 'the dead drop is a public utility.'"
permalink: /kql-library/hunting/hunt-blockchain-rpc-c2-dead-drop/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">hunt-blockchain-rpc-c2-dead-drop.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/hunting/hunt-blockchain-rpc-c2-dead-drop.kql' | relative_url }}" download="hunt-blockchain-rpc-c2-dead-drop.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-hunt-blockchain-rpc-c2-dead-drop" markdown="1">
