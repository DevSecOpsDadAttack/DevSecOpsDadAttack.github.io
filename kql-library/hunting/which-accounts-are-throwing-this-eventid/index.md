---
layout: page
title: Which Accounts Are Throwing This Eventid
subtitle: "Which accounts fire a specific Event ID and how often, per day."
permalink: /kql-library/hunting/which-accounts-are-throwing-this-eventid/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">which-accounts-are-throwing-this-eventid.kql</code>
</div>

<p class="kql-lib-query-longdesc">Which accounts fire a specific Event ID and how often, per day.</p>
...
<div class="kql-lib-query-actions">
  ...
  <button type="button" class="kql-lib-copy-btn" data-copy-target="kql-code-which-accounts-are-throwing-this-eventid">
    <i class="far fa-copy" aria-hidden="true"></i>&nbsp;Copy query
  </button>
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/hunting/eventid-forensics/which-accounts-are-throwing-this-eventid.kql' | relative_url }}" download="which-accounts-are-throwing-this-eventid.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-which-accounts-are-throwing-this-eventid" markdown="1">
