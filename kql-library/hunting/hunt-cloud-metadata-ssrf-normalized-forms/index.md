---
layout: page
title: Hunt Cloud Metadata Ssrf Normalized Forms
subtitle: "Cloud instance-metadata SSRF across every string-form the attacker can write — dotted, dotless, octal, hex, IPv6, dashed hostnames, encoded slashes. Normalizes before matching."
permalink: /kql-library/hunting/hunt-cloud-metadata-ssrf-normalized-forms/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">hunt-cloud-metadata-ssrf-normalized-forms.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/hunting/hunt-cloud-metadata-ssrf-normalized-forms.kql' | relative_url }}" download="hunt-cloud-metadata-ssrf-normalized-forms.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-hunt-cloud-metadata-ssrf-normalized-forms" markdown="1">
