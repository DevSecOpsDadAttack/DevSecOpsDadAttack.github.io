---
layout: page
title: Hunt Npm Postinstall Grandchild Network Payload
subtitle: "npm supply-chain worms where the payload runs two process generations down — 'sins of the grandfather' shape. Traces npm → sh -c → curl."
permalink: /kql-library/hunting/hunt-npm-postinstall-grandchild-network-payload/
js:
...
<div class="kql-lib-query-header">
  ...
  <code class="kql-lib-query-file">hunt-npm-postinstall-grandchild-network-payload.kql</code>
</div>
...
<div class="kql-lib-query-actions">
  ...
  <a class="kql-lib-download-btn" href="{{ '/assets/kql/hunting/hunt-npm-postinstall-grandchild-network-payload.kql' | relative_url }}" download="hunt-npm-postinstall-grandchild-network-payload.kql">
    <i class="fas fa-download" aria-hidden="true"></i>&nbsp;Download .kql
  </a>
</div>

<div id="kql-code-hunt-npm-postinstall-grandchild-network-payload" markdown="1">
